...
function getActivity(activity, activityName) {
  return {
    fontWeight:
      activityName.indexOf(activity) === -1
...
const Search = styled('div')(({ theme }) => ({
  ...
  backgroundColor: alpha(theme.palette.common.white, 1.10),
...
const SearchHompage = () => {
  ...
  return (
    <div>
      <Drawer
        anchor='top'
        open={open} onClose={(open) => setOpen(false)}
        classes={{
      ...
      >
        <Search className={classes.searchDrawer}>
          <SearchIconWrapper>
            <Link href="/">
              <img style={{ width: "30px", height: "30px" }} src='https://firebasestorage.googleapis.com/v0/b/places-99af3.appspot.com/o/places%2Fsearch.png?alt=media&token=99e26cee-8b3a-4e69-843f-a21eb0383bfe' />
            </Link>
          </SearchIconWrapper>
          <StyledInputBase
            placeholder="Search "
        ...
        <FormControl className={classes.region}>
          ...
          <InputLabel style={{ color: "white" }} id="demo-mutiple-name-label">Region</InputLabel>
          <Select
        ...
        <div className={classes.two} >
          ...
          <FormControl className={classes.formControl}>
            <InputLabel style={{ color: "white" }} id="demo-mutiple-name-label">Type of place</InputLabel>
            <Select
              size="small"
              labelId="demo-mutiple-name-label"
              id="demo-mutiple-name"
            ...
            >
              {type.map((type) => (
                <MenuItem key={type} value={type} style={getTypeOfPlace(type, typeName)}>
                  {type}
                </MenuItem>
              ))}
            </Select>
          ...
          <FormControl className={classes.formControl} style={{ marginLeft: "10%", }}>
            <InputLabel style={{ color: "white" }} id="demo-mutiple-name-label">Kind of place</InputLabel>
            <Select
              size="small"
              labelId="demo-mutiple-name-label"
              id="demo-mutiple-name"
            ...
            >
              {place.map((place) => (
                <MenuItem key={place} value={place} style={getPlace(place, placeName)}>
                  {place}
                </MenuItem>
              ))}
            </Select>
        ...
        <div className={classes.two} >
          ...
          <FormControl className={classes.formControl}>
            <InputLabel style={{ color: "white" }} id="demo-mutiple-name-label">Activity</InputLabel>
            <Select
              size="small"
              labelId="demo-mutiple-name-label"
              id="demo-mutiple-name"
            ...
            >
              {activity.map((activity) => (
                <MenuItem key={activity} value={activity} style={getActivity(activity, activityName)}>
                  {activity}
                </MenuItem>
              ))}
            </Select>
          ...
          <FormControl className={classes.formControl} style={{ marginLeft: "10%", }}>
            <InputLabel style={{ color: "white" }} id="demo-mutiple-name-label">Price Range</InputLabel>
            <Select
              size="small"
              labelId="demo-mutiple-name-label"
              id="demo-mutiple-name"
            ...
            >
              {price.map((price) => (
                <MenuItem key={price} value={price} style={getPriceRange(price, priceName)}>
                  {price}
                </MenuItem>
              ))}
            </Select>
